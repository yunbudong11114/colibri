    ...
    vec![
        ParityEntry {
            ...
            rust_tests: &[
                ...
                "gateway_hot_reload_applies_only_model_vision_and_web_search",
                "hot_reload_preserves_session_permission_grants",
            ],
            status: "partial",
        },
        ParityEntry {
            ...
            rust_tests: &[
                ...
                "repl_continues_after_model_error_like_python",
                "ask_returns_nonzero_for_exhausted_model_error",
        ...
        ParityEntry {
            ...
            rust_tests: &[
                ...
                "openai_compatible_retries_transient_http_error_then_succeeds",
                "openai_compatible_does_not_retry_permanent_http_error",
            ],
            status: "covered",
        },
        ParityEntry {
        ...
        ParityEntry {
            ...
            rust_tests: &[
                ...
                "session_compacts_when_model_input_tokens_reach_threshold_like_python",
                "session_does_not_log_context_budget_for_token_triggered_compaction_like_python",
                "session_returns_failed_turn_and_recovers_like_python",
                "session_keeps_large_tool_result_text_for_model_context_like_python",
                "context_pressure_warning_is_not_injected_for_large_model_input_like_python",
                "session_falls_back_and_logs_compact_error_like_python",
        ...
        ParityEntry {
            ...
            rust_tests: &[
                ...
                "web_search_aliyun_mcp_requires_key",
                "web_search_aliyun_mcp_maps_jsonrpc_error",
                "web_search_calls_aliyun_streamable_http_mcp",
...
fn mapped_python_tests_for_file(file: &str) -> &'static [&'static str] {
    match file {
        "test_channels.py" => &[
            ...
            "test_gateway_runner_keeps_session_after_model_error",
            "test_gateway_hot_reload_applies_only_model_vision_and_web_search",
            "test_gateway_hot_reload_preserves_session_permission_grants",
            "test_gateway_invalid_reload_keeps_last_known_good_runtime",
        ...
        "test_cli.py" => &[
            ...
            "test_repl_hot_reloads_model_vision_and_web_search_only",
            "test_repl_hot_reload_preserves_session_permission_grants",
            "test_repl_continues_after_model_error",
        ...
        "test_openai_compatible_model.py" => &[
            ...
            "test_complete_retries_transient_error_then_succeeds",
            "test_complete_does_not_retry_permanent_error",
            "test_complete_respects_zero_retries",
        ...
        "test_session.py" => &[
            ...
            "test_submit_returns_failed_turn_and_session_recovers",
        ...
        "test_tools.py" => &[
            ...
            "test_web_search_calls_aliyun_streamable_http_mcp",
            "test_web_search_aliyun_mcp_requires_key",
            "test_web_search_aliyun_mcp_maps_jsonrpc_error",
