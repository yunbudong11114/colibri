    ...
    vec![
        ParityEntry {
            ...
            rust_tests: &[
                ...
                "weixin_permission_reply_aliases_match_python",
        ...
        ParityEntry {
            ...
            rust_tests: &[
                ...
                "session_budgets_model_input_and_keeps_latest_user_like_python",
                "budget_model_messages_drops_complete_tool_call_group_like_python",
                "retain_recent_message_groups_keeps_tool_pairs_intact_like_python",
                "session_logs_context_budget_and_compact_mode_like_python",
        ...
        ParityEntry {
            ...
            rust_tests: &[
                "permission_policy_matches_python_session_and_project_grants",
        ...
        ParityEntry {
            ...
            rust_tests: &[
                "permission_policy_matches_python_session_and_project_grants",
                "project_permission_store_saves_and_loads_deduplicated_toml",
            ],
            status: "covered",
        },
        ParityEntry {
...
fn mapped_python_tests_for_file(file: &str) -> &'static [&'static str] {
    match file {
        ...
        "test_context.py" => &[
            ...
            "test_budget_model_messages_drops_oldest_non_system_and_keeps_latest_user",
            "test_budget_model_messages_drops_complete_tool_call_group",
        ],
        "test_diagnostics.py" => &[
            "test_build_diagnostics_reports_core_fields",
            "test_diagnostics_reports_project_permissions_file",
        ...
        "test_permissions_store.py" => &[
            "test_project_permission_store_loads_missing_file_as_empty",
            "test_project_permission_store_saves_and_loads_deduplicated_toml",
            "test_project_permission_store_loads_file_roots",
        ],
        "test_permissions.py" => &[
            "test_read_only_tool_is_allowed_under_default_policy",
            "test_confirm_policy_calls_prompter",
            "test_always_choice_allows_tool_for_current_session",
            ...
            "test_shell_project_command_grant_is_exact",
            ...
            "test_file_path_project_root_grant_allows_children_without_prompt",
        ],
        ...
        "test_session.py" => &[
            ...
            "test_session_budgets_model_input_and_logs_event",
