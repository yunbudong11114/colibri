...
class MemoryReadTool:
    spec = ToolSpec(
        name="memory.read",
        description="Read MEMORY.md, USER.md, INDEX.md, or a topic memory file.",
        input_schema={
            "type": "object",
            "properties": {
                "file": {"type": "string"},
...
class MemoryWriteTool:
    spec = ToolSpec(
        ...
        description=(
            ...
            "updated: YYYY-MM-DD\n"
            "---\n"
            "Choose USER.md for user profile, preferences, and collaboration style; keep it under 600 characters. "
            "Choose MEMORY.md for short stable general, project, or system facts; keep it under 1800 characters. "
            ...
            "Consolidate or replace USER.md and MEMORY.md instead of appending forever."
        ),
        input_schema={
            "type": "object",
            "properties": {
